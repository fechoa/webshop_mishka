...
/* Slider Start */
    let leftBtn = document.querySelector(".Reviews-ArrowButton_left");
    let rightBtn = document.querySelector(".Reviews-ArrowButton_right");

    let sliderTexts = document.querySelectorAll(".Reviews-Descr");
    let sliderAuthor = document.querySelectorAll(".Reviews-AuthorBox");


    leftBtn.addEventListener("click", function() {
        if (!sliderTexts[0].classList.contains("Reviews-Descr_off") && !sliderAuthor[0].classList.contains("Reviews-AuthorBox_off")) {
            sliderTexts[0].classList.add("Reviews-Descr_off");
            sliderAuthor[0].classList.add("Reviews-AuthorBox_off")

            sliderTexts[2].classList.remove("Reviews-Descr_off");
            sliderAuthor[2].classList.remove("Reviews-AuthorBox_off")
        }

        else if (!sliderTexts[1].classList.contains("Reviews-Descr_off") && !sliderAuthor[1].classList.contains("Reviews-AuthorBox_off")) {
            sliderTexts[1].classList.add("Reviews-Descr_off");
            sliderAuthor[1].classList.add("Reviews-AuthorBox_off")

            sliderTexts[0].classList.remove("Reviews-Descr_off");
            sliderAuthor[0].classList.remove("Reviews-AuthorBox_off")            
        }

        else if (!sliderTexts[2].classList.contains("Reviews-Descr_off") && !sliderAuthor[2].classList.contains("Reviews-AuthorBox_off")) {
            sliderTexts[2].classList.add("Reviews-Descr_off");
            sliderAuthor[2].classList.add("Reviews-AuthorBox_off")

            sliderTexts[1].classList.remove("Reviews-Descr_off");
            sliderAuthor[1].classList.remove("Reviews-AuthorBox_off")            
        }
    });
